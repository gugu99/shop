		...
		<div class="container">
			<div class="row">
				<div class="col-sm-6 col-sm-offset-3">
				    <form action="<%=request.getContextPath() %>/order/addOrderAction.jsp" id="addOrderForm" method="post">
						...
						<input type="text" name="addr" class="form-control" id="addr" placeholder="Enter Address"  readonly/>
						<button type="button" id="addrBtn" class="btn btn-default pull-right">우편번호 찾기</button>
						<input type="text" name="detailAddress"class="form-control" id="detailAddress" placeholder="Enter DetailAddress" />
				    	<div class="text-right">
				    		<button type="button" id="addOrderBtn" class="btn btn-green-moon btn-rounded">구매하기</button>
				    	</div>
				    </form>
				</div>
			</div>
